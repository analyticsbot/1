...
#DOCUMENT_TYPE_LEFT_ALLOWED = ["AFFIDAVIT"]
...
doc_types = ['AFFIDAVIT', 'POWER OF ATTNORNEY', 'ORDER', 'PROBATE', 'ADMENDMENT', 'SALE', 'JUDGEMENT', 'CERTIFICATE', 'RIDER', 'NOTICE', 'LIS PENDIS', 'ASSOCIATION LIEN', 'REQUEST', 'PERMIT', 'MEMORANDUM', 'WRIT', 'DIVORCE', 'ACKNOWLEDGEMENT', 'RECISSION']
"""
POSSIBLE VALUES
