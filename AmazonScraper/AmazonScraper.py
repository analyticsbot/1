...
auth = ('manutd0707', 'vbym5o5r80uvaer')
...
def review(number):
        ...
        if 'Looking for something' in looking_for_something:
            with open(filename3.format(number), "w") as myfile3:
        ...
        while True:
            ...
            if not sections:
                ...
                for section in sections:
                    ...
                    user_id = ''
                    try:
                        user_id = section.find('div', 'a-row').findNext('div', 'a-row').a['href'].split('profile/')[-1].split('/')[0].strip()
                    except:
                        pass
                    if not user_id:
                    ...
                    with open(filename2, "w") as myfile2:
                        ...
                        myfile2.write('"%s"\n' % (number_total_reviews))
                    pageNumber +=1
                    next_link = start_url.replace('pageNumber='+str(pageNumber-1), 'pageNumber='+str(pageNumber))
