...
filename = "reviews_allinfo600.csv"
filename2 = "reviews_notext600.csv"
    ...
    while True:
        ...
        if not sections:
            ...
            for section in sections:
                ...
                captcha_title = ''
                try:
                    captcha_title = review_soup.title.text
                except:
                    pass
                if 'Robot Check' in captcha_title:
                    print captcha_title, '22'
                while ((captcha_title == 'Robot Check') or (captcha_title == '500 Service Unavailable Error') or (captcha_title == '503 - Service Unavailable Error')):
                    time.sleep(random.randint(1, 4))
